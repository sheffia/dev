...
// saisie mot de passe et pwd

var emailUser = prompt("Bonjour, Saisissez votre Email ?", "<Saisissez votre Email>");
var mdpUser = prompt("Bonjour, Saisissez votre mot de passe ?", "<Saisissez votre mot de passe>");

var nbreUtilisateur = BaseDeDonnees.length;
l(nbreUtilisateur);
var authentificationOk = false;
var n = 0;
while (n < nbreUtilisateur) {
    if (emailUser === BaseDeDonnees[n].email && mdpUser === BaseDeDonnees[n].mdp
...
if (n = nbreUtilisateur && authentificationOk == false) {
    alert('Vos identifiant sont invalides !');
}
